...
export default class Login {
  ...
  handleSubmitEmployee = e => {
    ...
    this.login(user)
      .catch(
  // echec de connexion: catch appelle la fonction createUser qui n'est pas executée lors de test 
  ...
  handleSubmitAdmin = e => {
    ...
    this.login(user)
      .catch(
          // echec de connexion: catch appelle la fonction createUser qui n'est pas executée lors de te
          /* istanbul ignore next */
        (err) => this.createUser(user)
      )
      .then(() => {
